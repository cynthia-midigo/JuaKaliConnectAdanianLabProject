        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +254757417016</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> help@jkconnect.com</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i> Kiambu, Road 11</a></li>
                </ul>
                <ul class="header-links pull-right">
                    
                    @auth
                      <li><a style="color:white" href="{{route('user.history')}}">{{ auth()->user()->full_name }} </a></li> 
        ...
        <div id="header">
            ...
            <div class="container">
                ...
                <div class="row">
                    <!-- LOGO -->
                    <div class="col-md-3" >
                        <div class="header-logo" style="margin-right:100px;">
                    ...
                    <div class="col-md-6" >
                        <div class="header-search" >
                            <form action="{{route('user.search')}}" method="get" style="margin-left:50px;">
                                <div class="custom_search_top" style="margin-left:80px;">
                    ...
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <ul class="footer-links">
                                <li><a href="#"><i class="fa fa-map-marker"></i>16 Kiambu Road</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>+254757417016</a></li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i>help@jkconnect.com</a></li>
                            </ul>
                        </div>
